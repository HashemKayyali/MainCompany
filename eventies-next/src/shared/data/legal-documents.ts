...
export const legalDocuments: Record<LegalDocumentKey, LegalDocument> = {
  privacy: {
    ...
    ar: {
      ...
      note: 'يعمل Eventies حاليًا تحت اسم Eventies. قد يتم تحديث بيانات التسجيل الرسمي للشركة في هذه الصفحة عند توفرها.',
  ...
  cookies: {
    ...
    ar: {
      ...
      contactHeading: 'التواصل معنا',
      contactBody:
        'لأي أسئلة بخصوص ملفات الارتباط أو الخصوصية، تواصل معنا على support@eventiesjo.com.',
      sections: [
        {
        ...
        },
        {
          ...
          body: [
            'يستخدم Eventies حاليًا ملفات ارتباط أو تخزين مشابه ضروري لوظائف الموقع الأساسية، ومنها:',
          ],
          bullets: [
  ...
  terms: {
    ...
    ar: {
      ...
      lastUpdatedLabel: 'آخر تحديث',
      lastUpdated: '1 يوليو 2026',
      note: 'يعمل Eventies حاليًا تحت اسم Eventies. قد تتم إضافة بيانات التسجيل الرسمي للشركة عند توفرها.',
  ...
  vendorTerms: {
    ...
    ar: {
      ...
      contactBody:
        'لأسئلة انضمام المزودين أو القوائم أو الشراكات، تواصل على vendors@eventiesjo.com.',
      sections: [
        {
  ...
  refund: {
    ...
    ar: {
      ...
      contactBody:
        'لأسئلة الإلغاء أو تغيير الموعد أو الاسترداد، تواصل على support@eventiesjo.com أو booking@eventiesjo.com.',
      sections: [
        {
