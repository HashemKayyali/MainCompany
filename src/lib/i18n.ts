...
const en: Messages = {
  ...
  'common.status.empty': 'No results',
  ...
  'admin.layout.eventiesAdmin': 'Eventies Admin',
  'admin.layout.controlShell': 'Control shell',
  'admin.layout.openSite': 'Open Site',
  'admin.layout.exit': 'Exit',
  'admin.layout.openSidebar': 'Open sidebar',
  'admin.layout.closeSidebar': 'Close sidebar',
  'admin.layout.quickLinks': 'Quick links',
  'admin.layout.adminPanel': 'Admin Panel',
  'admin.layout.breadcrumbHome': 'Dashboard',
  'admin.meta.title': 'Admin',
  'admin.roles.owner': 'Owner',
  'admin.roles.admin': 'Administrator',
  'admin.roles.viewer': 'Viewer',
  'admin.roles.user': 'Workspace User',
  'admin.roles.superAdmin': 'Super Admin',
  'admin.roles.adminUser': 'Admin User',
  'admin.dialog.confirm': 'Confirm',
  'admin.dialog.delete': 'Delete',
  'admin.dialog.cancel': 'Cancel',
  'admin.dialog.ok': 'OK',
  'admin.dialog.closeModal': 'Close modal',
  'admin.breadcrumbs.rental': 'Rental',
  'admin.breadcrumbs.purchaseQuote': 'Purchase Quote Request',
  'admin.breadcrumbs.details': 'Details',
  'admin.breadcrumbs.create': 'Create',
  'admin.breadcrumbs.edit': 'Edit',
  'admin.breadcrumbs.new': 'New',}
...
const ar: Messages = {
  ...
  'common.status.empty': 'لا توجد نتائج',
  'common.status.error': 'خطأ',
  'common.status.success': 'تم بنجاح',
  ...
  'admin.nav.parts': 'القطع',
  'admin.nav.customers': 'العملاء',
  'admin.nav.categories': 'الفئات',
  'admin.nav.customBuilds': 'التنفيذات المخصصة',
  'admin.nav.gallery': 'المعرض',
  'admin.nav.users': 'المستخدمون',
  'admin.nav.admins': 'المسؤولون',
  'admin.nav.logs': 'السجلات',
  'admin.nav.main': 'الرئيسي',
  'admin.nav.access': 'الصلاحيات',
  'admin.layout.admin': 'الإدارة',
  'admin.layout.eventiesAdmin': 'إدارة Eventies',
  'admin.layout.controlShell': 'لوحة الإدارة',
  'admin.layout.openSite': 'فتح الموقع',
  'admin.layout.exit': 'خروج',
  'admin.layout.openSidebar': 'فتح القائمة الجانبية',
  'admin.layout.closeSidebar': 'إغلاق القائمة الجانبية',
  'admin.layout.quickLinks': 'روابط سريعة',
  'admin.layout.adminPanel': 'لوحة الإدارة',
  'admin.layout.breadcrumbHome': 'لوحة التحكم',
  'admin.meta.title': 'الإدارة',
  'admin.roles.owner': 'المالك',
  'admin.roles.admin': 'مسؤول',
  'admin.roles.viewer': 'مشاهد',
  'admin.roles.user': 'مستخدم مساحة العمل',
  'admin.roles.superAdmin': 'مسؤول رئيسي',
  'admin.roles.adminUser': 'مستخدم إداري',
  'admin.dialog.confirm': 'تأكيد',
  'admin.dialog.delete': 'حذف',
  'admin.dialog.cancel': 'إلغاء',
  'admin.dialog.ok': 'موافق',
  'admin.dialog.closeModal': 'إغلاق النافذة',
  'admin.breadcrumbs.rental': 'تأجير',
  'admin.breadcrumbs.purchaseQuote': 'طلب عرض سعر للشراء',
  'admin.breadcrumbs.details': 'التفاصيل',
  'admin.breadcrumbs.create': 'إنشاء',
  'admin.breadcrumbs.edit': 'تعديل',
  'admin.breadcrumbs.new': 'جديد',}
...
const arPhraseMap: Record<string, string> = {
  ...
  // Admin, modal, upload, and shared UI coverage.
  ...
  'Super Admins': 'المسؤولون الرئيسيون',
  'Standard Admins': 'المسؤولون العاديون',
  'Workspace User': 'مستخدم مساحة العمل',
  ...
  'Add Category / Brand': 'إضافة فئة / علامة',
  'Add Custom Build': 'إضافة تنفيذ مخصص',
  'Edit Product': 'تعديل الخدمة',
  'Edit Part': 'تعديل القطعة',
  'Edit Customer': 'تعديل العميل',
  'Edit Category': 'تعديل الفئة',
  'Edit Custom Build': 'تعديل التنفيذ المخصص',
  'Create Build': 'إنشاء تنفيذ',
  'Save Role': 'حفظ الدور',
  ...
  'No banner yet': 'لا توجد صورة غلاف بعد',
  'No values': 'لا توجد قيم',
  'No name': 'بلا اسم',
  'No users found.': 'لا يوجد مستخدمون.',
  'No long description yet.': 'لا يوجد وصف طويل بعد.',
  'In stock': 'متوفر',
  ...
  'Looks good': 'جيد',
  'Missing Field': 'حقل مطلوب',
  'Invalid Stock': 'مخزون غير صحيح',
  ...
  'Reorder Failed': 'فشل تغيير الترتيب',
  ...
  'Entity id': 'معرّف العنصر',
  'Request Details': 'تفاصيل الطلب',
  'Move to Preparation': 'نقل إلى التحضير',
  'Mark Contacted': 'تحديد أنه تم التواصل',
  'Mark Quoted': 'تحديد أنه تم التسعير',
  'Mark Won': 'تحديد كفائز',
  'Mark Lost': 'تحديد كمفقود',
  'Internal Notes': 'ملاحظات داخلية',
  'Role (default)': 'الدور (الافتراضي)',
  'Name A-Z': 'الاسم أ-ي',
  'Email A-Z': 'البريد أ-ي',
  'Oldest first': 'الأقدم أولًا',
  'Catalog Report': 'تقرير الكتالوج',
  'Products live': 'الخدمات المنشورة',
  'Featured products': 'الخدمات المميزة',
  'Hidden prices': 'الأسعار المخفية',
  'Out of stock parts': 'قطع غير متوفرة',
  'Catalog structure looks stable.': 'هيكل الكتالوج يبدو مستقرًا.',
  'Media Report': 'تقرير الوسائط',
  'Empty albums': 'ألبومات فارغة',
  'Some albums still need images.': 'بعض الألبومات ما زالت تحتاج صورًا.',
  'Access Report': 'تقرير الصلاحيات',
  'Registered users': 'المستخدمون المسجلون',
  'Access layer looks balanced.': 'طبقة الصلاحيات تبدو متوازنة.',
  'Needs Attention': 'تحتاج انتباه',
  'Products missing public price': 'خدمات بلا سعر ظاهر',
  ...
  'Access accounts': 'حسابات الصلاحيات',
  'Manage Products': 'إدارة الخدمات',
  'Open Logs': 'فتح السجلات',
  'Inspect accounts, roles, and contact details.': 'راجع الحسابات والأدوار وبيانات التواصل.',
  'Display name': 'اسم العرض',
  'Email is required': 'البريد الإلكتروني مطلوب',
  'Public slug': 'الرابط العام',
  'Category Name': 'اسم الفئة',
  'Category Details': 'تفاصيل الفئة',
  'Category Banner': 'صورة الفئة',
  'Category / Brand Image': 'صورة الفئة / العلامة',
  'Brand or category name': 'اسم العلامة أو الفئة',
  'Selected icon': 'الأيقونة المختارة',
  'Type or paste emoji to filter...': 'اكتب أو الصق رمزًا للتصفية...',
  'Product Name': 'اسم الخدمة',
  'Product Details': 'تفاصيل الخدمة',
  'Product Image': 'صورة الخدمة',
  'Product Video': 'فيديو الخدمة',
  'Part Name': 'اسم القطعة',
  'Part Details': 'تفاصيل القطعة',
  'Part Image': 'صورة القطعة',
  'Part Info': 'معلومات القطعة',
  'Customer Name': 'اسم العميل',
  'Build title': 'عنوان التنفيذ',
  'Build Content': 'محتوى التنفيذ',
  'Custom build': 'تنفيذ مخصص',
  'Custom Build': 'تنفيذ مخصص',
  'Custom Build Card': 'بطاقة التنفيذ المخصص',
  'Album Identity': 'هوية الألبوم',
  'Album Details': 'تفاصيل الألبوم',
  'Image count': 'عدد الصور',
  'Events 2025': 'فعاليات 2025',
  'Events, BTS, Products...': 'فعاليات، كواليس، خدمات...',
  'Linked product': 'خدمة مرتبطة',
  'Gallery items': 'عناصر المعرض',
  'Quick options': 'خيارات سريعة',
  'Quick Options': 'خيارات سريعة',
  'Quick options / Features': 'خيارات سريعة / ميزات',
  'Feature Columns': 'أعمدة الميزات',
  'Pricing & Commerce': 'التسعير والتجارة',
  'Pricing / Rental / Inventory': 'التسعير / التأجير / المخزون',
  'Rental & Inventory': 'التأجير والمخزون',
  'Day Price': 'سعر اليوم',
  'Listing Setup': 'إعداد العرض',
  'Short copy drives the product card; long copy supports the detail page.': 'الوصف القصير يظهر في بطاقة الخدمة؛ والوصف الطويل يدعم صفحة التفاصيل.',
  'Name / Category / Badge': 'الاسم / الفئة / الشارة',
  'Descriptions / Notes': 'الأوصاف / الملاحظات',
  'Images / Video': 'الصور / الفيديو',
  'Label (e.g. Bikes)': 'التسمية (مثال: دراجات)',
  'Values: 1, 2, 3, 4': 'القيم: 1، 2، 3، 4',
  'Remove Admin?': 'إزالة المسؤول؟',
  ...
  'Delete Product?': 'حذف الخدمة؟',
  'Reject Request?': 'رفض الطلب؟',
  'Send Password Reset?': 'إرسال إعادة تعيين كلمة المرور؟',
  'Could not load request details.': 'تعذر تحميل تفاصيل الطلب.',
  'Could not update request status.': 'تعذر تحديث حالة الطلب.',
  'Internal notes saved.': 'تم حفظ الملاحظات الداخلية.',
  'Could not save internal notes.': 'تعذر حفظ الملاحظات الداخلية.',
  'Could not load admin requests.': 'تعذر تحميل طلبات الإدارة.',
  'Approved from requests list': 'تمت الموافقة من قائمة الطلبات',
  'Could not approve request.': 'تعذرت الموافقة على الطلب.',
  'Rejected from requests list': 'تم الرفض من قائمة الطلبات',
  'Could not reject request.': 'تعذر رفض الطلب.',
  'Failed to save': 'تعذر الحفظ',
  'Failed to delete': 'تعذر الحذف',
  'Failed to add admin': 'تعذر إضافة المسؤول',
  'Failed to remove admin': 'تعذر إزالة المسؤول',
  'Failed to create custom build category': 'تعذر إنشاء فئة التنفيذ المخصص',
  'Failed to save custom build': 'تعذر حفظ التنفيذ المخصص',
  'Failed to delete custom build': 'تعذر حذف التنفيذ المخصص',
  'Failed to load users': 'تعذر تحميل المستخدمين',
  'Failed to update': 'تعذر التحديث',
  'Failed to send': 'تعذر الإرسال',
  'Failed to update product order.': 'تعذر تحديث ترتيب الخدمات.',
  'Product name is required.': 'اسم الخدمة مطلوب.',
  'Category is required.': 'الفئة مطلوبة.',
  'Failed to load data': 'تعذر تحميل البيانات',
  'Failed to load data from Supabase:': 'تعذر تحميل البيانات من Supabase:',
  'Failed to add product': 'تعذر إضافة الخدمة',
  'Failed to update product': 'تعذر تحديث الخدمة',
  'Failed to delete product': 'تعذر حذف الخدمة',
  'Failed to add part': 'تعذر إضافة القطعة',
  'Failed to update part': 'تعذر تحديث القطعة',
  'Failed to delete part': 'تعذر حذف القطعة',
  'Failed to add customer': 'تعذر إضافة العميل',
  'Failed to update customer': 'تعذر تحديث العميل',
  'Failed to delete customer': 'تعذر حذف العميل',
  'Failed to add category': 'تعذر إضافة الفئة',
  'Adjust Product Image': 'ضبط صورة الخدمة',
  'Adjust Product Video': 'ضبط فيديو الخدمة',
  'Adjust Category Image': 'ضبط صورة الفئة',
  'Adjust Customer Logo': 'ضبط شعار العميل',
  'Adjust Part Image': 'ضبط صورة القطعة',
  'Adjust Image Frame': 'ضبط إطار الصورة',
  'Adjust Video Frame': 'ضبط إطار الفيديو',
  'Frame Editor': 'محرر الإطار',
  'Frame Result': 'نتيجة الإطار',
  'Position Controls': 'أدوات التحكم بالموضع',
  'Pick custom background color': 'اختر لون خلفية مخصص',
  'Fit Mode': 'وضع الملاءمة',
  'Apply Frame': 'تطبيق الإطار',
  'Replace': 'استبدال',
  'Add Image': 'إضافة صورة',
  'Click or drop logo': 'اضغط أو اسحب الشعار',
  'Please upload a JPG, PNG, WebP, or GIF image.': 'يرجى رفع صورة بصيغة JPG أو PNG أو WebP أو GIF.',
  'Upload failed:': 'فشل الرفع:',
  'Failed to upload image. Please try again.': 'تعذر رفع الصورة. يرجى المحاولة مرة أخرى.',
  'Please upload a video file in MP4, WebM, MOV, or M4V format.': 'يرجى رفع فيديو بصيغة MP4 أو WebM أو MOV أو M4V.',
  'Video is too large. Max size is 50MB.': 'الفيديو كبير جدًا. الحد الأقصى 50MB.',
  'Video upload failed:': 'فشل رفع الفيديو:',
  'Failed to upload video: ': 'تعذر رفع الفيديو: ',
  'Search products, customers...': 'ابحث في الخدمات والعملاء...',
  'Search products, customers, requests...': 'ابحث في الخدمات والعملاء والطلبات...',
  'Customer': 'عميل',
  'Product Card Result': 'نتيجة بطاقة الخدمة',
  'Category Card Result': 'نتيجة بطاقة الفئة',
  'Part Card Result': 'نتيجة بطاقة القطعة',
  'Customer Card Result': 'نتيجة بطاقة العميل',
  'Album Card Result': 'نتيجة بطاقة الألبوم',
  'Live Product Card': 'بطاقة خدمة مباشرة',
  'Live Category Card': 'بطاقة فئة مباشرة',
  'Live Customer Card': 'بطاقة عميل مباشرة',
  'Live Album Card': 'بطاقة ألبوم مباشرة',
  'Live Part Card': 'بطاقة قطعة مباشرة',
  'Cover ready': 'الغلاف جاهز',
  'Banner uploaded': 'تم رفع الغلاف',}
