...
const ar: Messages = {
  ...
  'admin.dialog.ok': 'حسنا',
  'admin.dialog.delete': 'حذف',
...
const arPhraseMap: Record<string, string> = {
  ...
  'A small admin preview of the gallery tile.': 'معاينة إدارية مصغرة لبطاقة المعرض.',
  'A small admin preview of the part listing card.': 'معاينة إدارية مصغرة لبطاقة القطعة.',
  'A small admin preview of the public build card.': 'معاينة إدارية مصغرة لبطاقة التنفيذ العامة.',
  'A small admin preview, not a dominating public card.': 'معاينة إدارية مصغرة، وليست بطاقة عامة كبيرة.',
  Access: 'الوصول',
  'Access accounts': 'حسابات الوصول',
  'Access Report': 'تقرير الوصول',
  Action: 'الإجراء',
  Actions: 'الإجراءات',
  'Active stock': 'المخزون الفعال',
  'Active stock cannot be greater than total stock.': 'لا يمكن أن يتجاوز المخزون الفعال إجمالي المخزون.',
  'Activity Logs': 'سجلات النشاط',
  Actor: 'المنفذ',
  'Adaptive Grid': 'شبكة متكيفة',
  Add: 'إضافة',
  'Add a service to the catalog with media and pricing.': 'أضف خدمة إلى الكتالوج مع الوسائط والتسعير.',
  'Add Admin': 'إضافة مشرف',
  'Add Album': 'إضافة ألبوم',
  'Add Build': 'إضافة تنفيذ',
  'Add Category': 'إضافة فئة',
  'Add Customer': 'إضافة عميل',
  'Add Part': 'إضافة قطعة',
  'Add Product': 'إضافة منتج',
  Address: 'العنوان',
  'Adjust Category Image': 'ضبط صورة الفئة',
  'Adjust Custom Build Photo': 'ضبط صورة التنفيذ المخصص',
  'Adjust Customer Logo': 'ضبط شعار العميل',
  'Adjust frame': 'ضبط الإطار',
  'Adjust Frame': 'ضبط الإطار',
  'Adjust Gallery Photo': 'ضبط صورة المعرض',
  'Adjust Logo': 'ضبط الشعار',
  'Adjust Part Image': 'ضبط صورة القطعة',
  'Adjust Product Image': 'ضبط صورة المنتج',
  'Adjust Product Video': 'ضبط فيديو المنتج',
  Admin: 'مشرف',
  'Admin activity appears here when create, update, or delete events are recorded.': 'يظهر نشاط المشرفين هنا عند تسجيل عمليات إنشاء أو تحديث أو حذف.',
  'Admin navigation': 'تنقل لوحة الإدارة',
  'Admin sections': 'أقسام لوحة الإدارة',
  'Admin team members appear here after they are available from the existing auth context.': 'يظهر أعضاء فريق الإدارة هنا بعد توفرهم من نظام الحسابات.',
  'Admin Users': 'مستخدمو الإدارة',
  Admins: 'المشرفون',
  'Album Card': 'بطاقة الألبوم',
  'Album Identity': 'هوية الألبوم',
  'All actions': 'كل الإجراءات',
  'All admins': 'كل المشرفين',
  'All clear': 'كل شيء سليم',
  'All entities': 'كل العناصر',
  'All Logs': 'كل السجلات',
  'All products': 'كل المنتجات',
  'All roles': 'كل الأدوار',
  'Apply Frame': 'تطبيق الإطار',
  'Apply Role': 'تطبيق الدور',
  Approve: 'موافقة',
  'Approve request': 'الموافقة على الطلب',
  Availability: 'التوفر',
  'Available for purchase quote': 'متاح لطلب عرض سعر شراء',
  'Available for rental': 'متاح للتأجير',
  Back: 'رجوع',
  'Background color': 'لون الخلفية',
  'Background opacity': 'شفافية الخلفية',
  Badge: 'الشارة',
  'Banner / Image': 'البانر / الصورة',
  Basic: 'أساسي',
  'Brand or category name': 'اسم العلامة أو الفئة',
  Breadcrumbs: 'مسار التنقل',
  'Brief description of this brand or category...': 'وصف موجز لهذه العلامة أو الفئة...',
  'Buffer after (days)': 'فترة فاصلة بعد (أيام)',
  'Buffer before (days)': 'فترة فاصلة قبل (أيام)',
  'Build Photos': 'صور التنفيذ',
  Cancel: 'إلغاء',
  'Cannot Delete': 'لا يمكن الحذف',
  'Card layout': 'تخطيط البطاقات',
  Catalog: 'الكتالوج',
  'Catalog items': 'عناصر الكتالوج',
  'Catalog Report': 'تقرير الكتالوج',
  'Categories / Brands': 'الفئات / العلامات',
  'Categories with image': 'فئات لها صورة',
  'Category Card': 'بطاقة الفئة',
  'Category image': 'صورة الفئة',
  'Category is required.': 'الفئة مطلوبة.',
  Center: 'توسيط',
  'Change role': 'تغيير الدور',
  'Check albums, covers, and image framing.': 'راجع الألبومات والأغلفة وتأطير الصور.',
  'Check the actual customer card result while you refine the logo framing.': 'راجع بطاقة العميل الفعلية أثناء ضبط تأطير الشعار.',
  'Check the compact album tile while framing.': 'راجع بطاقة الألبوم المصغرة أثناء التأطير.',
  'Check the compact build card while framing.': 'راجع بطاقة التنفيذ المصغرة أثناء التأطير.',
  'Check the compact catalog card while framing.': 'راجع بطاقة الكتالوج المصغرة أثناء التأطير.',
  'Check the compact part card while framing.': 'راجع بطاقة القطعة المصغرة أثناء التأطير.',
  'Choose an icon': 'اختر أيقونة',
  'Choose the crop used inside this custom build card.': 'اختر القص المستخدم داخل بطاقة التنفيذ المخصص.',
  'Choose what should stay visible inside the gallery photo frame.': 'اختر ما يبقى ظاهرا داخل إطار صورة المعرض.',
  'Choose what should stay visible inside this custom build card frame.': 'اختر ما يبقى ظاهرا داخل إطار بطاقة التنفيذ المخصص.',
  'Choose what stays visible inside product cards and previews.': 'اختر ما يبقى ظاهرا داخل بطاقات المنتج والمعاينات.',
  'Choose what stays visible inside product previews.': 'اختر ما يبقى ظاهرا داخل معاينات المنتج.',
  City: 'المدينة',
  Close: 'إغلاق',
  'Collapse sidebar': 'طي الشريط الجانبي',
  'Compact Preview': 'معاينة مصغرة',
  Complete: 'إكمال',
  Confirm: 'تأكيد',
  Content: 'المحتوى',
  'Content / Category': 'المحتوى / الفئة',
  Cover: 'الغلاف',
  Create: 'إنشاء',
  Currency: 'العملة',
  'Current session': 'الجلسة الحالية',
  'Custom Build Card': 'بطاقة التنفيذ المخصص',
  Customer: 'العميل',
  'Customer / Contact': 'العميل / جهة الاتصال',
  'Customer Card Result': 'نتيجة بطاقة العميل',
  'Customer logos and groupings can be managed without changing the storefront data flow.': 'يمكن إدارة شعارات العملاء وتصنيفاتهم دون تغيير تدفق بيانات المتجر.',
  'Customer records': 'سجلات العملاء',
  'Customers with logo': 'عملاء لهم شعار',
  'Customers without category': 'عملاء بلا فئة',
  ...
  'Delete Category?': 'حذف الفئة؟',
  'Delete Custom Build?': 'حذف التنفيذ المخصص؟',
  'Delete Customer?': 'حذف العميل؟',
  'Delete part': 'حذف القطعة',
  'Delete Part?': 'حذف القطعة؟',
  ...
  Down: 'أسفل',
  'e.g. Bike Blender': 'مثال: خلاط الدراجة',
  Edit: 'تعديل',
  'Edit Album': 'تعديل الألبوم',
  'Edit Build': 'تعديل التنفيذ',
  ...
  'Editable here': 'قابل للتعديل هنا',
  'Email A-Z': 'البريد أ-ي',
  'Empty albums': 'ألبومات فارغة',
  'Enter the email of a registered user to make them an admin.': 'أدخل بريد مستخدم مسجل لجعله مشرفا.',
  Entity: 'العنصر',
  'Entity id': 'معرف العنصر',
  'Entity type': 'نوع العنصر',
  Error: 'خطأ',
  Event: 'الحدث',
  'Eventies Admin': 'إدارة Eventies',
  ...
  'Failed to upload video:': 'فشل رفع الفيديو:',
  'Feature columns': 'أعمدة المزايا',
  'Feature this build': 'إبراز هذا التنفيذ',
  'Featured product': 'منتج مميز',
  'Featured products': 'منتجات مميزة',
  'File Too Large': 'الملف كبير جدا',
  'Fill card': 'ملء البطاقة',
  'Filter admin role': 'تصفية دور المشرف',
  'Filter by action': 'تصفية حسب الإجراء',
  'Filter by entity': 'تصفية حسب العنصر',
  'Filter by linked product': 'تصفية حسب المنتج المرتبط',
  'Filter category icons': 'تصفية أيقونات الفئات',
  'Filter customers by category': 'تصفية العملاء حسب الفئة',
  'Filter or paste an icon...': 'صف أو الصق أيقونة...',
  'Filter users by role': 'تصفية المستخدمين حسب الدور',
  'Fit inside': 'احتواء بالكامل',
  'Fit or crop the logo inside the square logo frame.': 'احتو الشعار أو قصه داخل إطار الشعار المربع.',
  Flags: 'الحالات',
  Frame: 'الإطار',
  'Frame the part image without letting the preview dominate the editor.': 'أطر صورة القطعة دون أن تسيطر المعاينة على المحرر.',
  'Framing canvas': 'لوحة التأطير',
  'Full description': 'الوصف الكامل',
  'Gallery albums without photos': 'ألبومات معرض بلا صور',
  'Grand total': 'الإجمالي الكلي',
  Hero: 'رئيسية',
  'Hidden prices': 'أسعار مخفية',
  'Highlights the card on the storefront': 'يبرز البطاقة في المتجر',
  'Horizontal (X)': 'أفقي (X)',
  'Horizontal position': 'الموضع الأفقي',
  'Hover to preview': 'مرر للمعاينة',
  Icon: 'الأيقونة',
  Identity: 'الهوية',
  Image: 'الصورة',
  'Image actions': 'إجراءات الصورة',
  'Image too large': 'الصورة كبيرة جدا',
  'In stock': 'متوفر',
  'Inspect the real storefront card result while you adjust the frame.': 'راجع نتيجة بطاقة المتجر الحقيقية أثناء ضبط الإطار.',
  Internal: 'داخلي',
  'Internal Notes': 'ملاحظات داخلية',
  'Internal notes (one per line)': 'ملاحظات داخلية (واحدة في كل سطر)',
  'Invalid File': 'ملف غير صالح',
  'Invalid Stock': 'مخزون غير صالح',
  Item: 'العنصر',
  Items: 'العناصر',
  'Items / Services': 'العناصر / الخدمات',
  Joined: 'تاريخ الانضمام',
  'Keep Current': 'إبقاء الحالي',
  'Keep identity, product relation, price, and stock scannable in one compact form.': 'أبق الهوية وربط المنتج والسعر والمخزون واضحة في نموذج مضغوط واحد.',
  'Label (e.g. Bikes)': 'التسمية (مثال: دراجات)',
  'Leave empty to auto-generate from the name.': 'اتركه فارغا ليتم توليده تلقائيا من الاسم.',
  'Left column': 'العمود الأول',
  Line: 'سطر',
  'Line total': 'إجمالي السطر',
  'Linked product': 'المنتج المرتبط',
  'List View': 'عرض قائمة',
  'Live Customer Card': 'بطاقة العميل الحية',
  'Live Product Card': 'بطاقة المنتج الحية',
  Logo: 'الشعار',
  'Logo missing': 'الشعار مفقود',
  'Logo ready': 'الشعار جاهز',
  Logs: 'السجلات',
  'Long Description': 'الوصف الطويل',
  'Mark Contacted': 'تحديد كتم التواصل',
  'Mark Lost': 'تحديد كخسارة',
  'Mark Quoted': 'تحديد كمسعر',
  'Mark Won': 'تحديد كفوز',
  Media: 'الوسائط',
  'Media assets': 'أصول الوسائط',
  'Media Report': 'تقرير الوسائط',
  'Minimum rental days': 'الحد الأدنى لأيام التأجير',
  Missing: 'مفقود',
  'Missing Field': 'حقل ناقص',
  'Missing Logos': 'شعارات مفقودة',
  More: 'المزيد',
  'More actions': 'المزيد من الإجراءات',
  'More product actions': 'المزيد من إجراءات المنتج',
  'Move left': 'نقل لليسار',
  'Move right': 'نقل لليمين',
  'Move to Preparation': 'نقل إلى التجهيز',
  'MP4, WebM, MOV, M4V - opens a framing step after upload': 'MP4, WebM, MOV, M4V - تفتح خطوة التأطير بعد الرفع',
  'Must be less than or equal to total stock.': 'يجب أن يكون أقل من أو يساوي إجمالي المخزون.',
  Name: 'الاسم',
  'Name A-Z': 'الاسم أ-ي',
  'Name is required.': 'الاسم مطلوب.',
  'Name, slug, and category define how this customer is grouped in admin.': 'الاسم والمعرف والفئة تحدد كيفية تصنيف هذا العميل في لوحة الإدارة.',
  'Name, slug, and icon are grouped so the catalog label stays easy to scan.': 'الاسم والمعرف والأيقونة مجمعة لتبقى تسمية الكتالوج سهلة القراءة.',
  'Needs Attention': 'يحتاج إلى متابعة',
  'Never shown to customers; setup and sales context only.': 'لا تظهر للعملاء أبدا؛ للتجهيز وسياق المبيعات فقط.',
  'New category': 'فئة جديدة',
  'New custom build category': 'فئة تنفيذ مخصص جديدة',
  ...
  'No badge': 'بدون شارة',
  'No cover': 'بدون غلاف',
  'No direct actions for the current status.': 'لا توجد إجراءات مباشرة للحالة الحالية.',
  'No hero image uploaded': 'لم يتم رفع صورة رئيسية',
  'No image': 'لا توجد صورة',
  'No images in this album yet.': 'لا توجد صور في هذا الألبوم بعد.',
  'No photos uploaded yet.': 'لم يتم رفع صور بعد.',
  'No products match this filter': 'لا توجد منتجات مطابقة لهذه التصفية',
  'No quick options yet.': 'لا توجد خيارات سريعة بعد.',
  'No requests found': 'لا توجد طلبات',
  'No timeline entries yet.': 'لا توجد إدخالات في الجدول الزمني بعد.',
  Note: 'ملاحظة',
  'Nothing needs a manual pass right now.': 'لا يوجد ما يحتاج إلى مراجعة يدوية حاليا.',
  'Off storefront': 'خارج المتجر',
  Oldest: 'الأقدم',
  'Oldest first': 'الأقدم أولا',
  'One feature per line; these feed the detailed product view.': 'ميزة واحدة في كل سطر؛ تغذي عرض المنتج التفصيلي.',
  'Only super admins can manage admin access.': 'المشرفون العامون فقط يمكنهم إدارة صلاحيات المشرفين.',
  'Open navigation': 'فتح التنقل',
  'Operational Summary': 'ملخص تشغيلي',
  Operations: 'العمليات',
  'Option label': 'تسمية الخيار',
  'Option values': 'قيم الخيار',
  'Optional hover-preview video for the storefront card. Leave empty if the product has no video.': 'فيديو معاينة اختياري لبطاقة المتجر. اتركه فارغا إذا لم يكن للمنتج فيديو.',
  'Optional label shown on the storefront card.': 'تسمية اختيارية تظهر على بطاقة المتجر.',
  'Optional note for the status timeline...': 'ملاحظة اختيارية للجدول الزمني للحالة...',
  Options: 'الخيارات',
  Order: 'الترتيب',
  'Organise brands and category structure.': 'نظم العلامات وبنية الفئات.',
  'Out of stock parts': 'قطع غير متوفرة',
  Overview: 'نظرة عامة',
  'Page size': 'حجم الصفحة',
  Part: 'القطعة',
  'Part Card': 'بطاقة القطعة',
  'Part Content': 'محتوى القطعة',
  'Part image': 'صورة القطعة',
  'Part Image': 'صورة القطعة',
  'Part name': 'اسم القطعة',
  Parts: 'القطع',
  'Parts & Spares': 'القطع والإكسسوارات',
  'Parts out of stock': 'قطع غير متوفرة',
  Phone: 'الهاتف',
  Photos: 'الصور',
  'Photos high to low': 'الصور من الأكثر إلى الأقل',
  'Photos in gallery': 'صور في المعرض',
  'Photos low to high': 'الصور من الأقل إلى الأكثر',
  'Pick custom background color': 'اختر لون خلفية مخصصا',
  'Place the part neatly inside the square product-part frame.': 'ضع القطعة بدقة داخل الإطار المربع للقطعة.',
  Placement: 'الموضع',
  'Please upload a JPG, PNG, WebP, or GIF image.': 'يرجى رفع صورة بصيغة JPG أو PNG أو WebP أو GIF.',
  'Please upload a video file in MP4, WebM, MOV, or M4V format.': 'يرجى رفع فيديو بصيغة MP4 أو WebM أو MOV أو M4V.',
  'PNG / SVG / JPG · transparent background recommended': 'PNG / SVG / JPG · يفضل خلفية شفافة',
  'Position the image inside the category card frame.': 'ضع الصورة داخل إطار بطاقة الفئة.',
  'Preview Strip': 'شريط المعاينة',
  Previous: 'السابق',
  'Previous page': 'الصفحة السابقة',
  Price: 'السعر',
  'Price hidden': 'السعر مخفي',
  'Price high to low': 'السعر من الأعلى إلى الأدنى',
  'Price low to high': 'السعر من الأدنى إلى الأعلى',
  'Price shown': 'السعر ظاهر',
  'Price visible': 'السعر ظاهر',
  'Pricing & visibility': 'التسعير والظهور',
  'Pricing/Settings': 'التسعير/الإعدادات',
  'Private notes for the admin team...': 'ملاحظات خاصة لفريق الإدارة...',
  'Product Card Result': 'نتيجة بطاقة المنتج',
  'Product is required.': 'المنتج مطلوب.',
  'Product name': 'اسم المنتج',
  'Product name is required.': 'اسم المنتج مطلوب.',
  'Product video': 'فيديو المنتج',
  'Products high to low': 'المنتجات من الأكثر إلى الأقل',
  'Products live': 'منتجات منشورة',
  'Products low to high': 'المنتجات من الأقل إلى الأكثر',
  'Products missing public price': 'منتجات بلا سعر معلن',
  'Products with video': 'منتجات لها فيديو',
  'Public logo card source': 'مصدر بطاقة الشعار العامة',
  'Purchase quote totals are reviewed manually after the customer is contacted.': 'تتم مراجعة إجماليات عروض الشراء يدويا بعد التواصل مع العميل.',
  Qty: 'الكمية',
  'Quick Actions': 'إجراءات سريعة',
  'Quick options': 'خيارات سريعة',
  'Quote item': 'عنصر عرض السعر',
  Ready: 'جاهز',
  'Refine the gallery photo while checking the compact tile.': 'حسن صورة المعرض أثناء مراجعة البطاقة المصغرة.',
  'Refine the image while seeing the real storefront card result.': 'حسن الصورة أثناء رؤية نتيجة بطاقة المتجر الحقيقية.',
  'Refine this photo while checking the compact card.': 'حسن هذه الصورة أثناء مراجعة البطاقة المصغرة.',
  Refresh: 'تحديث',
  ...
  'Remove products from this category first.': 'أزل المنتجات من هذه الفئة أولا.',
  Rental: 'التأجير',
  'Rental & inventory': 'التأجير والمخزون',
  Reports: 'التقارير',
  'Request Details': 'تفاصيل الطلب',
  'Request not found': 'الطلب غير موجود',
  Requests: 'الطلبات',
  'Requests are not ready': 'الطلبات غير جاهزة',
  Reset: 'إعادة تعيين',
  Retry: 'إعادة المحاولة',
  'Review rental and purchase quote activity.': 'راجع نشاط التأجير وعروض أسعار الشراء.',
  'Right column': 'العمود الثاني',
  Role: 'الدور',
  'Role changes use the existing admin RPC flow.': 'تغييرات الأدوار تستخدم مسار الإدارة الحالي.',
  Rows: 'الصفوف',
  Sale: 'البيع',
  Save: 'حفظ',
  'Save Internal Notes': 'حفظ الملاحظات الداخلية',
  'Search actor, entity, ID, or details': 'ابحث بالمنفذ أو العنصر أو المعرف أو التفاصيل',
  'Search admins': 'بحث في المشرفين',
  'Search album, slug, category...': 'ابحث بالألبوم أو المعرف أو الفئة...',
  'Search by name or email': 'ابحث بالاسم أو البريد',
  'Search by name, badge, category...': 'ابحث بالاسم أو الشارة أو الفئة...',
  'Search by name, email, or phone': 'ابحث بالاسم أو البريد أو الهاتف',
  'Search by name, slug, or category': 'ابحث بالاسم أو المعرف أو الفئة',
  'Search custom builds': 'بحث في التنفيذات المخصصة',
  'Search customers': 'بحث في العملاء',
  'Search gallery albums': 'بحث في ألبومات المعرض',
  'Search logs': 'بحث في السجلات',
  'Search name, slug, description...': 'ابحث بالاسم أو المعرف أو الوصف...',
  'Search part, product, description...': 'ابحث بالقطعة أو المنتج أو الوصف...',
  'Search parts': 'بحث في القطع',
  'Search products': 'بحث في المنتجات',
  'Search request, customer, or email...': 'ابحث بالطلب أو العميل أو البريد...',
  'Search requests': 'بحث في الطلبات',
  'Search title, category, description...': 'ابحث بالعنوان أو الفئة أو الوصف...',
  ...
  'Send Reset Email': 'إرسال بريد إعادة التعيين',
  Session: 'الجلسة',
  'Short copy drives the product card; the full description supports the detail page.': 'النص القصير يغذي بطاقة المنتج؛ والوصف الكامل يدعم صفحة التفاصيل.',
  'Short description': 'الوصف القصير',
  'Short Description': 'الوصف القصير',
  'Short label + comma-separated values.': 'تسمية قصيرة + قيم مفصولة بفواصل.',
  'Short operational reports so you can see what is healthy and what needs cleanup.': 'تقارير تشغيلية قصيرة لترى ما هو سليم وما يحتاج إلى معالجة.',
  'Show less': 'عرض أقل',
  'Show more': 'عرض المزيد',
  'Show on public page': 'عرض في الصفحة العامة',
  'Show price': 'عرض السعر',
  'Show pricing publicly': 'عرض التسعير للعامة',
  Showing: 'عرض',
  'Shown on the storefront card; keep it to a line or two.': 'يظهر على بطاقة المتجر؛ اجعله سطرا أو سطرين.',
  Slug: 'المعرف',
  'Slug (URL)': 'المعرف (الرابط)',
  'Sort admins': 'ترتيب المشرفين',
  'Sort albums': 'ترتيب الألبومات',
  'Sort categories': 'ترتيب الفئات',
  'Sort custom builds': 'ترتيب التنفيذات المخصصة',
  'Sort customers': 'ترتيب العملاء',
  'Sort logs': 'ترتيب السجلات',
  'Sort parts': 'ترتيب القطع',
  'Sort requests': 'ترتيب الطلبات',
  'Sort users': 'ترتيب المستخدمين',
  'Standard Admins': 'مشرفون عاديون',
  'Start from the most common admin tasks without hunting through the navigation.': 'ابدأ من أكثر المهام الإدارية شيوعا دون البحث في القوائم.',
  'Start over': 'البدء من جديد',
  Status: 'الحالة',
  'Status Actions': 'إجراءات الحالة',
  'Status History': 'سجل الحالة',
  'Status note': 'ملاحظة الحالة',
  'Status toggles are large enough for mobile and easy to scan on desktop.': 'مفاتيح الحالة كبيرة بما يكفي للجوال وسهلة القراءة على الحاسوب.',
  Stock: 'المخزون',
  'Stock / Flags': 'المخزون / الحالات',
  'Stock and buffer windows keep availability checks and request approvals aligned.': 'المخزون والفترات الفاصلة يبقيان فحوصات التوفر وموافقات الطلبات متوافقة.',
  'Stock status': 'حالة المخزون',
  Storefront: 'المتجر',
  'Storefront hover preview': 'معاينة تمرير للمتجر',
  Subtotal: 'المجموع الفرعي',
  'Super Admin': 'مشرف عام',
  'Super admin role can only be changed from Supabase dashboard.': 'دور المشرف العام لا يتغير إلا من لوحة تحكم Supabase.',
  'Super admins': 'المشرفون العامون',
  'Super Admins': 'المشرفون العامون',
  'Team member': 'عضو الفريق',
  'The banner remains compact here; framing opens in the shared image placement dialog.': 'يبقى البانر مضغوطا هنا؛ ويفتح التأطير في نافذة ضبط الصورة المشتركة.',
  'The first image becomes the storefront hero automatically. Keep the strongest framed image in slot one.': 'الصورة الأولى تصبح الصورة الرئيسية للمتجر تلقائيا. أبق أقوى صورة في الموضع الأول.',
  'The first photo becomes the cover. Controls stay visible for tap users.': 'الصورة الأولى تصبح الغلاف. تبقى الأزرار ظاهرة لمستخدمي اللمس.',
  'The first photo is the cover. Controls remain visible on touch devices.': 'الصورة الأولى هي الغلاف. تبقى الأزرار ظاهرة على أجهزة اللمس.',
  'The request URL does not match a supported request type.': 'رابط الطلب لا يطابق نوع طلب مدعوما.',
  'These are the items most likely to require a manual pass next.': 'هذه هي العناصر الأكثر احتمالا لأن تحتاج مراجعة يدوية.',
  'This is the exact public storefront card customers will see.': 'هذه هي بطاقة المتجر العامة نفسها التي سيراها العملاء.',
  'This request may have been removed or is no longer available.': 'ربما تمت إزالة هذا الطلب أو لم يعد متاحا.',
  'This uses the same logo card component shown on the public homepage.': 'يستخدم هذا نفس مكون بطاقة الشعار المعروض في الصفحة الرئيسية العامة.',
  'This will permanently remove': 'سيؤدي هذا إلى إزالة نهائية لـ',
  Title: 'العنوان',
  'Title is required.': 'العنوان مطلوب.',
  'Title, category, and slug stay compact and close to the photo manager.': 'يبقى العنوان والفئة والمعرف مضغوطة وقريبة من مدير الصور.',
  'Title, category, order, and category creation stay in one compact editing group.': 'العنوان والفئة والترتيب وإنشاء الفئة تبقى في مجموعة تحرير مضغوطة واحدة.',
  Total: 'الإجمالي',
  'Total high to low': 'الإجمالي من الأعلى إلى الأدنى',
  'Total low to high': 'الإجمالي من الأدنى إلى الأعلى',
  'Total stock': 'إجمالي المخزون',
  'Totals Summary': 'ملخص الإجماليات',
  'Try a different search or category, or add a new product.': 'جرب بحثا أو فئة مختلفة، أو أضف منتجا جديدا.',
  'Try a different search, type, status, or sort option.': 'جرب بحثا أو نوعا أو حالة أو ترتيبا مختلفا.',
  Type: 'النوع',
  ...
  'Upload, replace, remove, or frame the customer logo before saving.': 'ارفع أو استبدل أو أزل أو أطر شعار العميل قبل الحفظ.',
  Uploaded: 'مرفوع',
  'User accounts will appear here after they are available from Supabase.': 'ستظهر حسابات المستخدمين هنا بعد توفرها من Supabase.',
  Users: 'المستخدمون',
  'Values: 1, 2, 3, 4': 'القيم: 1، 2، 3، 4',
  'Vertical (Y)': 'رأسي (Y)',
  'Vertical position': 'الموضع الرأسي',
  Video: 'الفيديو',
  'Video is too large. Max size is 50MB.': 'الفيديو كبير جدا. الحد الأقصى 50MB.',
  'Video ready': 'الفيديو جاهز',
  'View details': 'عرض التفاصيل',
  'View Requests': 'عرض الطلبات',
  Visibility: 'الظهور',
  'Visibility / Featured': 'الظهور / الإبراز',
  Visible: 'ظاهر',
  'Visible Logs': 'السجلات الظاهرة',
  'We could not load this request': 'تعذر تحميل هذا الطلب',
  When: 'الوقت',
  'With Logos': 'لها شعارات',
  'Workspace Summary': 'ملخص مساحة العمل',
  You: 'أنت',
  Grid: 'شبكة',
  List: 'قائمة',
  'On request': 'عند الطلب',
  'Bike Blender activation': 'تفعيل خلاط الدراجة',
  'Events 2026': 'فعاليات 2026',
  'Events, BTS, Products...': 'فعاليات، كواليس، منتجات...',
  ...
  'Add to Rental': 'أضف للتأجير',
  'Remove Rental': 'إزالة التأجير',
